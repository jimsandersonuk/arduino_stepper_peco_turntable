...
//		int arraySize = sizeof(PositionTrack);
	...
	void displayMainMenu (int dispMenu)
	{
		...
		switch (dispMenu)
		{
			...
			case 1:
				...
				break;
			case 2:
				displayMainMenuFooter = String(F ("3 Setup Menu"));
				displayOutput(false,displayMainMenuHeader, displayMainMenuFooter);
				break;
	...
	void displaySubMenuA (int dispMenu)
	{
		...
		displaySubMenuAHeader = String(F ("Setup Menu"));

		switch (dispMenu)
		{
			case 0:
				displaySubMenuAFooter = String(F ("1 Turntable Menu"));
				displayOutput(false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 1:
				displaySubMenuAFooter = String(F ("2 Calibration"));
				displayOutput(false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 2:
				displaySubMenuAFooter = String(F ("3 Clear Tracks"));
				displayOutput(false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 3:
				displaySubMenuAFooter = String(F ("4 Debug Mode"));
				displayOutput(false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 4:
	...
	void displaySubMenuB (int dispMenu)
	{
		...
		displaySubMenuBHeader = String (F ("Turntable Menu"));

		switch (dispMenu)
		{
			case 0:
				displaySubMenuBFooter = String (F ("1 Setup Tracks"));
				displayOutput (false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
			case 1:
				displaySubMenuBFooter = String (F ("2 Check Tracks"));
				displayOutput (false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
			case 2:
				displaySubMenuBFooter = String (F ("3 Track Settings"));
				displayOutput (false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
			case 3:
				displaySubMenuBFooter = String (F ("4 Setup Menu"));
				displayOutput (false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
		}
	}
	...
	void selectSubMenuB (int selectSubMenu)
	{
		...
		{
			case 0:		//	Setup Tracks
				selectSubMenuBHeader = String (F ("Track Positions"));
				selectSubMenuBFooter = String (F ("Move bridge"));
				displayOutput (false, selectSubMenuBHeader, selectSubMenuBFooter);
				newMenu = true;
				selectProgrammedTargetTracks ();
				break;
			case 1:
				selectSubMenuBHeader = String (F ("Verify Tracks"));
				displayOutput (false, selectSubMenuBHeader, selectSubMenuBFooter);
				newMenu = true;
				stayInMenu = true;
				do
